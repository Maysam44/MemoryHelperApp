    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.iconWrapper}>
          <MaterialCommunityIcons name="microphone-outline" size={80} color={COLORS.primary} />
        </View>
        <Text style={styles.title}>استخدام الميكروفون</Text>
        <Text style={styles.subtitle}>
          نحتاج للميكروفون لتتمكن من تسجيل رسائل صوتية وتذكيرات سريعة لأحبائك.
        </Text>
      </View>

      <View style={styles.footer}>
        <TouchableOpacity style={styles.button} onPress={handleRequestPermission}>
          <Text style={styles.buttonText}>تفعيل الميكروفون</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.skipButton} onPress={() => router.push('/permissions/notifications')}>
